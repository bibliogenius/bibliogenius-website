...
description: Deux lecteurs se connectent dans BiblioGenius en scannant un QR code ou en partageant un lien d'invitation, et voient alors la bibliothèque l'un de l'autre.
order: 5
group: social
---
