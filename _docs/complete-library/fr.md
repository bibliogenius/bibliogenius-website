...
BiblioGenius peut compléter automatiquement les données manquantes de vos livres, pour toute votre bibliothèque en une seule opération, sans avoir à les modifier un par un.
